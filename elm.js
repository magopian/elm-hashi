...
{
	if (region.Y.G === region.ae.G)
	{
		return 'on line ' + region.Y.G;
	}
	return 'on lines ' + region.Y.G + ' through ' + region.ae.G;
}
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {S: oldTime, av: request, ax: subs};
	});
	...
	return A3(
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$field,
				'target',
				A2($elm$json$Json$Decode$field, info.aN, $elm$json$Json$Decode$bool))));
};
...
var $evancz$elm_playground$Playground$Mouse = F4(
	function (x, y, down, click) {
		return {aJ: click, aK: down, aD: x, aE: y};
	});
...
var $evancz$elm_playground$Playground$updateKeyboard = F3(
	function (isDown, key, keyboard) {
		var keys = isDown ? A2($elm$core$Set$insert, key, keyboard.f) : A2($elm$core$Set$remove, key, keyboard.f);
		switch (key) {
			case ' ':
				return _Utils_update(
					keyboard,
		...
		switch (msg.$) {
			case 1:
				...
				return A3(
					...
					computer.R.aJ ? _Utils_update(
						computer,
						{
							R: A2($evancz$elm_playground$Playground$mouseClick, false, computer.R),
							L: time
						}) : _Utils_update(
						computer,
						{L: time}));
			case 2:
				var viewport = msg.a.aB;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
					_Utils_update(
						computer,
						{
							U: A2($evancz$elm_playground$Playground$toScreen, viewport.aC, viewport.ah)
						}));
			case 3:
				var w = msg.a;
				var h = msg.b;
				return A3(
					...
					_Utils_update(
						computer,
						{
							U: A2($evancz$elm_playground$Playground$toScreen, w, h)
						}));
			case 0:
				var isDown = msg.a;
				var key = msg.b;
				return A3(
					...
					_Utils_update(
						computer,
						{
							F: A3($evancz$elm_playground$Playground$updateKeyboard, isDown, key, computer.F)
						}));
			case 5:
				var pageX = msg.a;
				var pageY = msg.b;
				var y = computer.U._ - pageY;
				var x = computer.U.q + pageX;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
					_Utils_update(
						computer,
						{
							R: A3($evancz$elm_playground$Playground$mouseMove, x, y, computer.R)
						}));
			case 6:
				return A3(
					$evancz$elm_playground$Playground$Game,
					...
					_Utils_update(
						computer,
						{
							R: A2($evancz$elm_playground$Playground$mouseClick, true, computer.R)
						}));
			case 7:
				var isDown = msg.a;
				return A3(
					...
					_Utils_update(
						computer,
						{
							R: A2($evancz$elm_playground$Playground$mouseDown, isDown, computer.R)
						}));
			default:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							F: $evancz$elm_playground$Playground$emptyKeyboard,
							R: A4($evancz$elm_playground$Playground$Mouse, computer.R.aD, computer.R.aE, false, false)
						}));
		}
	});
...
var $evancz$elm_playground$Playground$initialComputer = {
	F: $evancz$elm_playground$Playground$emptyKeyboard,
	R: A4($evancz$elm_playground$Playground$Mouse, 0, 0, false, false),
	U: A2($evancz$elm_playground$Playground$toScreen, 600, 600),
...
var $evancz$elm_playground$Playground$render = F2(
	function (screen, shapes) {
		var y = $elm$core$String$fromFloat(screen.O);
		var x = $elm$core$String$fromFloat(screen.q);
		var w = $elm$core$String$fromFloat(screen.aC);
		var h = $elm$core$String$fromFloat(screen.ah);
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $evancz$elm_playground$Playground$game = F3(
	function (viewMemory, updateMemory, initialMemory) {
		...
		return $elm$browser$Browser$document(
			{aj: init, aU: subscriptions, az: update, aA: view});
	});
...
var $author$project$Levels$Point = F3(
	function (x, y, connections) {
		return {ac: connections, aD: x, aE: y};
	});
var $author$project$Levels$coordinatesToMaybePoint = F3(
	function (x, y, numConnections) {
		return (numConnections > 0) ? $elm$core$Maybe$Just(
			A3($author$project$Levels$Point, x, y, numConnections)) : $elm$core$Maybe$Nothing;
	});
var $author$project$Levels$toCenterBasedCoord = F3(
	function (width, height, _v0) {
		var x = _v0.aD;
		var y = _v0.aE;
		var connections = _v0.ac;
		return A3($author$project$Levels$Point, x - ((width / 2) | 0), -(y - ((height / 2) | 0)), connections);
	});
var $author$project$Levels$next = F2(
	function (width, height) {
		...
		return A2(
			$elm$core$List$map,
			A2($author$project$Levels$toCenterBasedCoord, width, height),
			A2(
						...
						F2(
							function (j, row) {
								return A2(
									$elm$core$List$indexedMap,
									F2(
										function (i, numConnections) {
											return A3($author$project$Levels$coordinatesToMaybePoint, i, j, numConnections);
										}),
									row);
							}),
						points))));
...
var $author$project$Main$isHorizontal = F2(
	function (p1, p2) {
		return _Utils_eq(p1.aE, p2.aE);
	});
var $author$project$Main$isVertical = F2(
	function (p1, p2) {
...
var $author$project$Main$Double = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Main$Single = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var $author$project$Main$removeConnection = F2(
	function (connections, connection) {
		return A2(
			...
			function (conn) {
				return !_Utils_eq(conn, connection);
			},
			connections);
	});
var $author$project$Main$manageConnections = F3(
	function (connections, a, b) {
		var _v0 = ((_Utils_cmp(a.aD, b.aD) < 0) || (_Utils_cmp(a.aE, b.aE) < 0)) ? _Utils_Tuple2(a, b) : _Utils_Tuple2(b, a);
		var first = _v0.a;
		var second = _v0.b;
		var _double = A2($author$project$Main$Double, first, second);
		var single = A2($author$project$Main$Single, first, second);
		return A2($elm$core$List$member, single, connections) ? _Utils_ap(
			A2($author$project$Main$removeConnection, connections, single),
			_List_fromArray(
				[_double])) : (A2($elm$core$List$member, _double, connections) ? A2($author$project$Main$removeConnection, connections, _double) : _Utils_ap(
			connections,
			_List_fromArray(
				[single])));
	});
var $author$project$Main$gameSize = 10;
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $elm$core$Basics$round = _Basics_round;
var $author$project$Main$screen_to_game = F2(
	function (screen, coord) {
		var screenSize = A2($elm$core$Basics$min, screen.aC, screen.ah);
		return $elm$core$Basics$round(coord * ($author$project$Main$gameSize / screenSize));
	});
var $author$project$Main$update = F2(
	function (computer, model) {
		var mouseY = A2($author$project$Main$screen_to_game, computer.U, computer.R.aE);
		var mouseX = A2($author$project$Main$screen_to_game, computer.U, computer.R.aD);
		var mousePoint = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (_v3) {
					var x = _v3.aD;
					...
					switch (_v2.$) {
						case 0:
							return _Utils_update(
								model,
								{
									h: $author$project$Main$One(point)
								});
						case 1:
						...
						default:
							var firstSelected = _v2.a;
							var secondSelected = _v2.b;
							return _Utils_eq(firstSelected, point) ? _Utils_update(
								model,
								{
									h: $author$project$Main$One(secondSelected)
								}) : (_Utils_eq(secondSelected, point) ? _Utils_update(
								model,
								{
									h: $author$project$Main$One(firstSelected)
								}) : _Utils_update(
								model,
								{
									h: $author$project$Main$One(point)
...
var $author$project$Main$game_to_screen = function (screen) {
	var screenSize = A2($elm$core$Basics$min, screen.aC, screen.ah);
	return screenSize / $author$project$Main$gameSize;
};
...
var $author$project$Main$rectangleForPoints = F4(
	function (color, a, b, width) {
		var y = A2($elm$core$Basics$max, a.aE, b.aE) - A2($elm$core$Basics$min, a.aE, b.aE);
		var x = A2($elm$core$Basics$max, a.aD, b.aD) - A2($elm$core$Basics$min, a.aD, b.aD);
		return (_Utils_cmp(x, y) > 0) ? A3(
			$evancz$elm_playground$Playground$move,
			(b.aD - a.aD) / 2,
			0,
			A3(
				...
				a.aD,
				a.aE,
				A3($evancz$elm_playground$Playground$rectangle, color, x, width))) : A3(
			$evancz$elm_playground$Playground$move,
			0,
			(b.aE - a.aE) / 2,
			A3(
				...
				a.aD,
				a.aE,
				A3($evancz$elm_playground$Playground$rectangle, color, width, y)));
	});
var $author$project$Main$viewConnection = function (connection) {
	if (!connection.$) {
		var a = connection.a;
		var b = connection.b;
		return A4($author$project$Main$rectangleForPoints, $evancz$elm_playground$Playground$blue, a, b, $author$project$Main$connectionWidth);
	} else {
		var a = connection.a;
		var b = connection.b;
		return $evancz$elm_playground$Playground$group(
			_List_fromArray(
				[
					A4($author$project$Main$rectangleForPoints, $evancz$elm_playground$Playground$blue, a, b, $author$project$Main$doubleConnectionWidth),
					A4($author$project$Main$rectangleForPoints, $evancz$elm_playground$Playground$white, a, b, $author$project$Main$doubleConnectionWidth - ($author$project$Main$connectionWidth * 2))
				]));
	}
};
...
var $author$project$Main$viewNumConnection = function (point) {
	return A2(
		...
		A3(
			...
			A2(
				...
				$elm$core$String$fromFloat(point.ac))));
};
...
var $author$project$Main$viewSelection = F2(
	function (selection, fadeSelection) {
		var fadeBy = function () {
			if (!fadeSelection.$) {
				var f = fadeSelection.a;
				return f / 10;
			} else {
				return 1;
			}
		...
		switch (selection.$) {
			case 0:
				return A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$white, 0);
			case 1:
				var firstSelected = selection.a;
				return A2(
					...
					A3(
						...
						firstSelected.aD,
						firstSelected.aE,
						A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$yellow, $author$project$Main$innerCircleSize)));
			default:
				var firstSelected = selection.a;
				var secondSelected = selection.b;
				return A2(
					$evancz$elm_playground$Playground$fade,
					fadeBy,
					$evancz$elm_playground$Playground$group(
	...
	function (computer, model) {
		return _List_fromArray(
			[
				A2(
				$evancz$elm_playground$Playground$scale,
				$author$project$Main$game_to_screen(computer.U),
				$evancz$elm_playground$Playground$group(
